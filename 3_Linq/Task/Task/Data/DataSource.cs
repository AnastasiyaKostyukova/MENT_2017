...
namespace Task.Data
{
  public class DataSource
  {
    ...
    public List<Product> Products
    {
      get
      {
        if (productList == null) createLists();
    ...
    public List<Supplier> Suppliers
    {
      get
      {
        if (supplierList == null) createLists();
    ...
    public List<Customer> Customers
    {
      get
      {
        if (customerList == null) createLists();
    ...
    private void createLists()
    {
      ...
      customerList = (from e in XDocument.Parse(Properties.Resources.Customers).Root.Elements("customer")
                      select
                      new Customer
                        {
